...
#define QUANTRACKER_AIR_OUTPUT_TYPE_FRSKY  1
#define QUANTRACKER_AIR_OUTPUT_TYPE_3DR_MODEM 2

#define QUANTRACKER_AIR_OUTPUT_TYPE QUANTRACKER_AIR_OUTPUT_TYPE_3DR_MODEM
