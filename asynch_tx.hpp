#ifndef QUANTRACKER_AIR_ASYNCH_TX_HPP_INCLUDED
#define QUANTRACKER_AIR_ASYNCH_TX_HPP_INCLUDED
...
int16_t asynch_tx_write(asynch_tx_char_type const * buf);

#endif //QUANTRACKER_AIR_ASYNCH_TX_HPP_INCLUDED
